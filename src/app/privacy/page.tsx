 ...
 * No Privacy Policy text has been written. Do NOT draft legal language here;
    ...
    <>
      ...
      <main id="main-content" className="mx-auto w-full max-w-[860px] px-6 py-[clamp(56px,8vw,104px)]">
        ...
        <p className="mb-4 max-w-[62ch] text-[17px] leading-[1.65] text-ink-soft">
          Skumetra&apos;s Privacy Policy is being finalized for the Founding Seller Pilot. This page must be
